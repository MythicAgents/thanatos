...
use crate::crypto::errors::Base64Error;
...
pub fn decode(data: impl AsRef<str>) -> Result<Vec<u8>, Base64Error> {
    ...
    let mut decoded_len: u32 = decoded_len
        .try_into()
        .map_err(|_| Base64Error::DataTooLong)?;
    ...
    unsafe {
        ...
        .map_err(|_| Base64Error::MalformedData)?
    };
