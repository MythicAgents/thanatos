    ...
    for (let i = 0; i < responses.length; i++) {
      ...
      for (let j = 0; j < processes.length; j++) {
        ...
        if (pinfo["start_time"] != null) {
          let date = new Date(parseInt(pinfo["start_time"]) * 1000);
